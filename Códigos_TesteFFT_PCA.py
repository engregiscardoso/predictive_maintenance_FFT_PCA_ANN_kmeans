...
string = r'images\KMeans_FFT_PCA2.png'
plt.savefig(string)
plt.show()
plt.cla()   # Clear axis
...
plt.xticks(fontsize=17)  # Tamanho dos ticks do eixo X
plt.yticks(fontsize=17)  # Tamanho dos ticks do eixo Y
string = r'images\KMeans_FFT_PCA3.png'
plt.savefig(string)
plt.show()
plt.cla()   # Clear axis
plt.clf()   # Clear figure
...
plt.xticks(fontsize=17)  # Tamanho dos ticks do eixo X
plt.yticks(fontsize=17)  # Tamanho dos ticks do eixo Y
string = r'images\KMeans_FFT_PCA4.png'
plt.savefig(string)
plt.show()
plt.cla()   # Clear axis
plt.clf()   # Clear figure
...
plt.xticks(fontsize=17)  # Tamanho dos ticks do eixo X
plt.yticks(fontsize=17)  # Tamanho dos ticks do eixo Y
string = r'images\KMeans_FFT_PC5.png'
plt.savefig(string)
plt.show()
plt.cla()   # Clear axis
plt.clf()   # Clear figure
...
plt.xticks(fontsize=17)  # Tamanho dos ticks do eixo X
plt.yticks(fontsize=17)  # Tamanho dos ticks do eixo Y
string = r'images\KMeans_FFT_PC6.png'
plt.savefig(string)
plt.show()
plt.cla()   # Clear axis
plt.clf()   # Clear figure
...
plt.xticks(fontsize=17)  # Tamanho dos ticks do eixo X
plt.yticks(fontsize=17)  # Tamanho dos ticks do eixo Y
string = r'images\KMeans_FFT_PC7.png'
plt.savefig(string)
plt.show()
plt.cla()   # Clear axis
plt.clf()   # Clear figure
...
plt.xticks(fontsize=17)  # Tamanho dos ticks do eixo X
plt.yticks(fontsize=17)  # Tamanho dos ticks do eixo Y
string = r'images\KMeans_FFT_PC8.png'
plt.savefig(string)
plt.show()
plt.cla()   # Clear axis
plt.clf()   # Clear figure
...
plt.xticks(fontsize=17)  # Tamanho dos ticks do eixo X
plt.yticks(fontsize=17)  # Tamanho dos ticks do eixo Y
string = r'images\KMeans_FFT_PC9.png'
plt.savefig(string)
plt.show()
plt.cla()   # Clear axis
plt.clf()   # Clear figure
...
plt.xticks(fontsize=17)  # Tamanho dos ticks do eixo X
plt.yticks(fontsize=17)  # Tamanho dos ticks do eixo Y
string = r'images\KMeans_FFT_PC10.png'
plt.savefig(string)
plt.show()
plt.cla()   # Clear axis
plt.clf()   # Clear figure
...
#Melhor configuração PCA2: {'qnt_neuronios': 10, 'loss': 0.019100461155176163, 'accuracy': 1.0}
#Melhor configuração PCA3: {'qnt_neuronios': 10, 'loss': 0.023912984877824783, 'accuracy': 1.0}
#Melhor configuração PCA4: {'qnt_neuronios': 10, 'loss': 0.012360820546746254, 'accuracy': 1.0}
#Melhor configuração PCA5: {'qnt_neuronios': 10, 'loss': 0.021656328812241554, 'accuracy': 1.0}
#Melhor configuração PCA6: {'qnt_neuronios': 10, 'loss': 0.013789743185043335, 'accuracy': 1.0}
#Melhor configuração PCA7: {'qnt_neuronios': 10, 'loss': 0.01407946553081274, 'accuracy': 1.0}
#Melhor configuração PCA8: {'qnt_neuronios': 10, 'loss': 0.011290986090898514, 'accuracy': 1.0}
#Melhor configuração PCA9: {'qnt_neuronios': 10, 'loss': 0.012166982516646385, 'accuracy': 1.0}
#Melhor configuração PCA10: {'qnt_neuronios': 10, 'loss': 0.012033161707222462, 'accuracy': 1.0}
####
...
### Neurons for 1 layer
neuronios = [10, 10, 10, 10, 10, 10, 10, 10, 10]
...
## LEMBRAR DE COLOCAR TAMBEM OS SINAL DE FFT PARA CADA LABEL
...
plt.xticks(fontsize=17)  # Tamanho dos ticks do eixo X
plt.yticks(fontsize=17)  # Tamanho dos ticks do eixo Y
string = r'images\ANN_FFT_PCA.png'
plt.savefig(string)
plt.show()
plt.cla()   # Clear axis
plt.clf()   # Clear figure
